...
<nav class="navbar navbar-expand-lg main-navbar">
    <form id="formChangeLab" method="post" class="form-inline mr-auto" action="{{ route('user-lab.change_lab') }}">
        ...
        <div class="search-element">
            {{ Form::select("id_selected_lab", Session::get('list-lab') ,Session::get('selected-lab'), ["class" => "form-control", "id" => "id_selected_lab"]) }}
        </div>
    </form>
...
<script type="text/javascript">
    $(function () {
        $("#id_selected_lab").on("change", function() { 
            $('#formChangeLab').submit();
        } );
    });
