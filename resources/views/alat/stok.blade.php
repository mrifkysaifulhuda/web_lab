    ...
    <div class="main-content" style="min-height: 593px;">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <ul class="nav nav-pills" id="myTab3" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link " id="home-tab3" href="/alat/show/{{$data->id_alat}}" role="tab" aria-controls="home" aria-selected="true">Detail</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active show" id="profile-tab3"  href="/alat/stok/{{$data->id_alat}}" role="tab" aria-controls="profile" aria-selected="false">Kartu Stok</a>
                      </li>
                    </ul>
                  </div>
                  {{ Form::open(array('id'=>'formStoreStok', 'data-action' => route('alat.store_stok') )) }}
                  {{ Form::hidden('id_alat', $data->id_alat) }}
                  <div class="card-body">
                    <div id="messages">
                    </div>
      ...
      <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            ...
            {{ Form::open(array('id'=>'formDeleteStok', 'data-action' => route('alat.destroy_stok') )) }}
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                ajax: "{{ route('alat.list_stok',['id' => $data->id_alat]) }}",
                columns: [
